        ...
        loop(i,1,n+1){
            ...
            while(options.size() && deg[i] < 2){
                ...
                if(deg[u] < 2){
                    ...
                    deg[i]++;
                    temp.emplace(u);
                    if(ans.size() == m)goto print;
                }
                options.erase(options.begin());
            }
            if(ans.size() == m)goto print;
            for(auto j: temp)if(deg[j] < 2)options.emplace(j);
        }
        print:
        if(ans.size() == m){
